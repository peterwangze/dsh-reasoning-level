  ...
  factory: (require) => {
    ...
    const LANG = {
      zh: {
        ...
        testingNote: '测试按钮发一个 1-token 请求验证某模型某等级实际可用（网关拒绝会自动加入黑名单）；导出可下载 CSV。',
      ...
      en: {
        ...
        testingNote: 'Test sends a 1-token request to verify a model/level works (gateway rejection auto-blacklists); Export downloads CSV.',
    ...
    function StatsPanel(props) {
      ...
      return el('div', null,
        ...
        el('div', { style: sectionTitle }, t('recentCalls')),
        el('table', { style: tableStyle },
          el('thead', null, el('tr', null,
