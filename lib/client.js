      ...
      return el('div', null,
        ...
        el('table', { style: tableStyle },
          el('thead', null, el('tr', null,
            ...
            el('th', { style: cellStyle }, '思考 tokens'),
            el('th', { style: cellStyle }, '输出 tokens'),
          )),
          el('tbody', null, modelRows.map(([key, agg]) => el('tr', { key },
            ...
            el('td', { style: cellStyle }, String(agg.reasoningTokens)),
        ...
        el('table', { style: tableStyle },
          ...
          el('tbody', null, (stats.recent ?? []).slice(0, 20).map((r, i) => el('tr', { key: i },
            ...
            el('td', { style: cellStyle }, r.effort === null ? '(默认)' : (LEVEL_LABELS[r.effort] || r.effort) + '(' + r.effort + ')'),
            el('td', { style: cellStyle }, r.rt === null ? '—' : String(r.rt)),
      ...
      return el('div', null,
        el('div', { style: rowStyle },
          ...
          el('select', {
            ...
            (models ?? []).map((m) => el('option', { key: m.key, value: m.key },
              m.label + (m.efforts.length > 0 ? '' : '（无推理等级）')))),
